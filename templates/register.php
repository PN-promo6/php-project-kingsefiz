...
<body>
    ...
    <div class="container-login100" style="background-image: url('/img/bg-img/bg-01.jpg');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form" method="POST" action="?action=register">
                ...
                <div class="text-center p-t-57 p-b-20">
                    <p class="txt2 hov1"> <span class="txt1">Already have an account ? </span><a href="?action=login">Login</a></p>
                </div>
                <?php
